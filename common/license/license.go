...
var (
	...
	ErrNotValid               = errors.New("license is not valid, contact your administrator or our support at https://docs.lyric.tech/access")
	ErrDataMaskingUnsupported = errors.New("data masking is enabled for this connection but is not supported with the open source license, disable it or contact our support at https://docs.lyric.tech/access")
	ErrWebhooksUnsupported    = errors.New("webhooks is enabled for this connection but is not supported with the open source license, disable it or contact our support at https://docs.lyric.tech/access")
