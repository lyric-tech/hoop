...
var protectionGuardrailCatalog = map[string]protectionGuardrailSpec{
	"Lyric IAM - Unsafe update and delete": {
		Name:        "Lyric IAM - Unsafe update and delete",
	...
	"Lyric IAM - Destructive DDL": {
		Name:        "Lyric IAM - Destructive DDL",
	...
	"Lyric IAM - Select without limit": {
		Name:        "Lyric IAM - Select without limit",
	...
	"Lyric IAM - Select star on sensitive tables": {
		Name:        "Lyric IAM - Select star on sensitive tables",
	...
	"Lyric IAM - PHI columns": {
		Name:        "Lyric IAM - PHI columns",
	...
	"Lyric IAM - Bulk export": {
		Name:        "Lyric IAM - Bulk export",
	...
	"Lyric IAM - Redis flush": {
		Name:        "Lyric IAM - Redis flush",
	...
	"Lyric IAM - MongoDB drops": {
		Name:        "Lyric IAM - MongoDB drops",
	...
	"Lyric IAM - Dangerous shell commands": {
		Name:        "Lyric IAM - Dangerous shell commands",
	...
	"Lyric IAM - Risky kubectl": {
		Name:        "Lyric IAM - Risky kubectl",
	...
	"Lyric IAM - Pipe to shell": {
		Name:        "Lyric IAM - Pipe to shell",
	...
	"Lyric IAM - IAM escalation": {
		Name:        "Lyric IAM - IAM escalation",
	...
	"Lyric IAM - SSN in output": {
		Name:        "Lyric IAM - SSN in output",
...
var protectionMaskingCatalog = map[string]protectionMaskingSpec{
	"Lyric IAM - PHI strict": {
		Name:                 "Lyric IAM - PHI strict",
	...
	"Lyric IAM - Confidential data": {
		Name:                 "Lyric IAM - Confidential data",
	...
	"Lyric IAM - Full masking": {
		Name:                 "Lyric IAM - Full masking",
	...
	"Lyric IAM - Credentials only": {
		Name:                 "Lyric IAM - Credentials only",
...
var protectionAnalyzerCatalog = map[string]protectionAnalyzerSpec{
	"Lyric IAM - Block high risk PHI": {
		Name:               "Lyric IAM - Block high risk PHI",
		Description:        "Blocks high-risk sessions, routes medium-risk to approval. PHI access is treated as high risk.",
		RiskEvaluationJSON: "{\"low_risk\": {\"action\": \"allow_execution\"},\"medium_risk\": {\"action\": \"require_access_request\",\"access_request_rule_name\": \"Lyric IAM-Command_approval\"},\"high_risk\": {\"action\": \"block_execution\"}}",
	},
	"Lyric IAM - Block high risk": {
		Name:               "Lyric IAM - Block high risk",
		Description:        "Blocks high-risk sessions, routes medium-risk sessions to approval.",
		RiskEvaluationJSON: "{\"low_risk\": {\"action\": \"allow_execution\"},\"medium_risk\": {\"action\": \"require_access_request\",\"access_request_rule_name\": \"Lyric IAM-Command_approval\"},\"high_risk\": {\"action\": \"block_execution\"}}",
	},
	"Lyric IAM - Review high risk": {
		Name:               "Lyric IAM - Review high risk",
		Description:        "Routes high-risk sessions to approval.",
		RiskEvaluationJSON: "{\"low_risk\": {\"action\": \"allow_execution\"},\"medium_risk\": {\"action\": \"allow_execution\"},\"high_risk\": {\"action\": \"require_access_request\",\"access_request_rule_name\": \"Lyric IAM-Command_approval\"}}",
	},
}
...
var protectionProfileCatalog = map[string]protectionProfileSpec{
	"hipaa-ready": {
		...
		EnterpriseOnly: true,
		Guardrails:     []string{"Lyric IAM - Unsafe update and delete", "Lyric IAM - Destructive DDL", "Lyric IAM - Select star on sensitive tables", "Lyric IAM - PHI columns", "Lyric IAM - Bulk export", "Lyric IAM - Redis flush", "Lyric IAM - MongoDB drops", "Lyric IAM - Dangerous shell commands", "Lyric IAM - Risky kubectl", "Lyric IAM - Pipe to shell", "Lyric IAM - IAM escalation", "Lyric IAM - SSN in output"},
		Masking:        []string{"Lyric IAM - PHI strict"},
		AccessRules:    []string{"Lyric IAM-JIT_4_hours", "Lyric IAM-Command_approval"},
		Analyzers:      []string{"Lyric IAM - Block high risk PHI"},
	},
	"soc2-type2": {
		ID:             "soc2-type2",
		...
		EnterpriseOnly: true,
		Guardrails:     []string{"Lyric IAM - Unsafe update and delete", "Lyric IAM - Destructive DDL", "Lyric IAM - Bulk export", "Lyric IAM - Redis flush", "Lyric IAM - MongoDB drops", "Lyric IAM - Dangerous shell commands", "Lyric IAM - Risky kubectl", "Lyric IAM - Pipe to shell", "Lyric IAM - IAM escalation"},
		Masking:        []string{"Lyric IAM - Confidential data"},
		AccessRules:    []string{"Lyric IAM-JIT_8_hours", "Lyric IAM-Command_approval"},
		Analyzers:      []string{"Lyric IAM - Review high risk"},
	},
	"protection-permissive": {
		...
		Guardrails:    []string{"Lyric IAM - Unsafe update and delete"},
		Masking:       []string{"Lyric IAM - API Keys"},
		AccessRules:   []string{},
		Analyzers:     []string{},
	},
	"protection-medium": {
		...
		EnterpriseOnly: true,
		Guardrails:     []string{"Lyric IAM - Unsafe update and delete", "Lyric IAM - Destructive DDL", "Lyric IAM - Select star on sensitive tables", "Lyric IAM - Bulk export", "Lyric IAM - Redis flush", "Lyric IAM - MongoDB drops", "Lyric IAM - Dangerous shell commands"},
		Masking:        []string{"Lyric IAM - Confidential data"},
		AccessRules:    []string{"Lyric IAM-JIT_8_hours", "Lyric IAM-Command_approval"},
		Analyzers:      []string{"Lyric IAM - Review high risk"},
	},
	"protection-high": {
		...
		EnterpriseOnly: true,
		Guardrails:     []string{"Lyric IAM - Unsafe update and delete", "Lyric IAM - Destructive DDL", "Lyric IAM - Select without limit", "Lyric IAM - Select star on sensitive tables", "Lyric IAM - Bulk export", "Lyric IAM - Redis flush", "Lyric IAM - MongoDB drops", "Lyric IAM - Dangerous shell commands", "Lyric IAM - Risky kubectl", "Lyric IAM - Pipe to shell", "Lyric IAM - IAM escalation", "Lyric IAM - SSN in output"},
		Masking:        []string{"Lyric IAM - Full masking"},
		AccessRules:    []string{"Lyric IAM-JIT_2_hours", "Lyric IAM-Command_approval"},
		Analyzers:      []string{"Lyric IAM - Block high risk"},
	},
}
